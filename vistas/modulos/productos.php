          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control input-lg" id="nuevoCodigo"min=0 name="nuevoCodigo" placeholder="Ingresar código" onblur="buscar_datos();" required>
            ...
            <!-- ENTRADA PARA LA DESCRIPCIÓN -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control input-lg" name="nuevoStock" id="nuevoStock" min="0" placeholder="Stock" required>
            ...
            <!-- ENTRADA PARA SUBIR FOTO -->
             ...
             <div class="form-group">
              ...
              <img src="vistas/img/productos/default/anonymous.png" class="img-thumbnail previsualizar" id="imagen" width="100px">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control input-lg" id="editarCodigo" name="editarCodigo" required>
            ...
            <!-- ENTRADA PARA LA DESCRIPCIÓN -->
             ...
             <?php
             if($_SESSION["permiteModificarStock"]=='off'){
            ...
            <div class="form-group row" >
             ...
             <?php
                ...
                if( $_SESSION["costoProductos"]=='off'){
                  echo ' <div class="col-xs-6" hidden>';
  ...
  function buscar_datos()
  {
    ...
    $.ajax(
    {
      ...
      success:  function (valores) 
      {
        ...
        $("#nuevaDescripcion").hide();
        $("#nuevoStock").val(valores.nuevoStock);
        $("#nuevoPrecioCompra").val(valores.nuevoPrecioCompra);
        $("#nuevoPrecioVenta").val(valores.nuevoPrecioVenta);
        $("#nuevaImagen").val(valores.nuevaImagen);

        $("#imagen").val(valores.nuevaImagen);
