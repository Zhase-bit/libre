...
class ControladorVentas{
	...
	static public function ctrCrearVenta(){
		...
		if(isset($_POST["nuevaVenta"])){
			...
			/*=============================================
			ACTUALIZAR LAS COMPRAS DEL CLIENTE Y REDUCIR EL STOCK Y AUMENTAR LAS VENTAS DE LOS libroS
			=============================================*/
			...
			foreach ($listalibros as $key => $value) {
			   ...
			   $tablalibros = "libros";
			    ...
			    $nuevasVentas = Modelolibros::mdlActualizarlibro($tablalibros, $item1a, $valor1a, $valor);
	...
	static public function ctrEditarVenta(){
		...
		if(isset($_POST["editarVenta"])){
			...
			if($cambiolibro){
				...
				$libros =  json_decode($traerVenta["libros"], true);
				...
				foreach ($libros as $key => $value) {
					...
					$item1a = "ventas";
					$valor1a = $traerlibro["ventas"] - $value["cantidad"];
				...
				foreach ($listalibros_2 as $key => $value) {
					...
					$item1a_2 = "ventas";
					$valor1a_2 = $value["cantidad"] + $traerlibro_2["ventas"];

					$nuevasVentas_2 = Modelolibros::mdlActualizarlibro($tablalibros_2, $item1a_2, $valor1a_2, $valor_2);
